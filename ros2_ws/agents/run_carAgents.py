...
car_ids = [f"car_{i+1}" for i in range(5)]
agent_processes = []
all_zones = [
    [(1.0, 1.0), (1.0, 8.0), (8.0, 8.0), (8.0, 1.0)],
    [(17.0, 17.0), (17.0, 10.0), (10.0, 10.0), (10.0, 17.0)],
    [(1.0, 17.0), (8.0, 17.0), (8.0, 8.0), (1.0, 8.0)],
    [(17.0, 1.0), (10.0, 1.0), (10.0, 8.0), (8.0, 17.0)]
]
...
try:
    for i, car_id in enumerate(car_ids):
        ...
        patrol_points_args = [str(coord) for point in all_zones[i % len(all_zones)] for coord in point]        
